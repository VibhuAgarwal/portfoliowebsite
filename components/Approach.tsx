  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading capitalize">
        My <span className="text-purple">thinking approach</span>
      </h1>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 w-full gap-4 mx-auto px-8">
        <Card
          ...
          description="I always try to plan and understand the requirements and goals of my clients. 
                  I also try to understand the business and project requirements to ensure that 
                  I can deliver the best possible solution. "
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="I always try to understand the business and project requirements to ensure that I can deliver the best possible solution. "
        >
          <CanvasRevealEffect
            animationSpeed={3}
