      ...
      <div className="flex justify-center relative my-20 z-10 ">
        <div className="max-w-[89vw] md:mx-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Creating seamless full stack applications using NextJS"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl capitalize">
            Hi, I&apos;m Vibhor Agarwal, A next js developer
          </p>
          <a href="#about">
            <MagicButton
              title="Show My Work"
