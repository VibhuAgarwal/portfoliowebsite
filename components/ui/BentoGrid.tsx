...
export const BentoGridItem = ({
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText("agarwalvibhor930@gmail.com");
    setCopied(true);
  };
  return (
    <div
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["Next.js", "React.js", "Typescript"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132E]" />
                {["React Query", "Material UI", "Context API"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100
                                  rounded-lg text-center bg-[#10132E]"
